...
function download(){
	open(`${window.location.href}download?note=${settings['notation']}&bg=%23${settings['background'].slice(1)}&border=${settings['borderWidth']*0.005}&size=${settings['imageSize']}&${settings['inputMode']}=${settings['moves']}&fd=${settings['initialFacets']}`);
}